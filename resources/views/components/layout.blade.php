                        ...
                        <ul class="space-y-1 list-none">
                            @foreach ($communities as $c)
                                ...
                                <li class="community-item group">
                                    <div
                                        class="flex items-center justify-between px-2 py-1 transition {{ $active ? 'bg-blue-100' : 'hover:bg-blue-50' }}">
                                        <a href="/dashboard?community={{ $c->slug }}"
                                            ...
                                            <span
                                                class="text-xs text-gray-400 block">{{ ucfirst($c->visibility) }}</span>
                                        </a>
            ...
            <div class="flex items-center justify-between bg-white border-b px-6 relative">
                ...
                <div class="flex items-center gap-4 ml-auto">
                    ...
                    <div class="relative mt-2">
                        @if (!empty($community))
                            <a href="{{ route('events', ['community' => $community->slug, 'tab' => 'calendar']) }}"
