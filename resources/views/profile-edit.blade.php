                ...
                <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="relative">
                        <textarea name="bio" id="bio" rows="4"
                            class="peer w-full rounded-xl border border-gray-300 bg-white/70 px-4 pt-6 pb-2 text-sm shadow-sm focus:border-sky-400 focus:ring-2 focus:ring-sky-200 focus:outline-none transition">{{ old('bio', Auth::user()->bio) }}</textarea>
                        <label for="bio"
                            class="absolute left-4 top-2.5 text-xs text-gray-500 peer-focus:text-sky-500 transition">
                            Bio
                        </label>
